    ...
    <div class="content easypay-manager">
        <div class="content-inner">
                ...
                <el-tab-pane label="东风金融-创格详情" name="first">
                    ...
                    <section class="info-card-A">
                        ...
                        <div class="card-bd card-bd-row">
                            ...
                            <el-row>
                                <el-col :span="8" class="lb_body">
                                    <span class="info-key">原始东风金融-创格编号:</span>
                            ...
                            <div class="card-bd marrimg" style="padding:24px 30px 51px 30px;">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <el-table-column prop="invoiceAmount" label="开具金额(元)" width="120" align="left">
                                            <template slot-scope="scope">
                                                <el-badge
                                                        class="isdot"
            ...
            <div class="card-footer" v-if="$route.query.isshowbtn==1&&$route.query.checkbtn==1">
                ...
                <a href="javascript:;" style="display: inline-block;margin: 0 5px;" @click="showDialog(checked,'1')">《东风金融-创格转让协议》</a>
                ...
                if (!data.hild) {
                    ...
                    let content = [
                        ...
                        h(
                            ...
                            {},
                            "是否已融资：" +
                            (data.payableBillFinanceList.length > 0
                                ? "是(点击查看)"
                                : "否")
                        )
                    ];
...
<style lang='scss'>
    ...
    .content {
        ...
        .card-number {
            ...
            height: 72px;
            border-bottom: 2px #FF4D60 solid;
            line-height: 72px;
            &-title {
                display: inline-block;
                font-size: 14px;
