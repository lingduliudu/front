    ...
    <div class="content">
        <el-tabs v-model="activetab">
            <el-tab-pane label="东风金融-创格详情" name="first">
                ...
                <section class="info-card-A">
                    <div class="card-hd sub-title">
                        ...
                        <el-button class="page-head-back" style="color: rgba(227, 1, 32, 1);" size="small" @click="preview">预览
                        </el-button>
                    </div>
                    <div class="card-bd">
                        <el-row>
            ...
            <span class="info-value">{{item.contractNo}}</span><a class="page-head-back downsize"
                                                                  style="color: rgba(227, 1, 32, 1);" size="small"
                    ...
                    <div class="card-hd" style="height: 150px;" v-if="$route.query.isshowbtn==1">
                        <el-row style="padding-top: 40px;">
                            ...
                            <el-col :span="8" class="lb_body">
                                <el-button
                                        style="width: 160px;height: 40px;background: rgba(227, 1, 32, 1);color:#ffffff;font-size:16px;"
                    ...
                    <div class="card-hd" style="height: 150px;" v-if="$route.query.isshowbtn==2">
                        <el-row style="padding-top: 40px;">
                            <el-col :span='7' class="lb_body" :offset="10">
                                <el-button
                                        style="width: 160px;height: 40px;font-size:16px;background: rgba(227, 1, 32, 1);color:#ffffff;"
