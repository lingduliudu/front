        ...
        <el-tabs type="border-card" v-model="activeName" class="n-tabs">
          ...
          >
            <el-table
              ...
              style="width: 100%;"
              >
              <el-table-column prop="termCode" label="期数编码" min-width="150"></el-table-column>
              <el-table-column prop="period" label="期数" min-width="150"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      isHedden: false,
      loading: false,
      otherFunc: [{ text: "+ 新增产品期数", func: this.openDialog }],
      filterList: [
        {
          label: "启用状态:",
          type: "select",
