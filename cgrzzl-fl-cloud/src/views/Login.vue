              ...
              <el-form
                ...
                <el-form-item style="width:100%;margin-top: -15px;">
                  <el-button
                    class="login-btn"
                    type="primary"
                    style="width:100%;background: rgba(227, 1, 32, 1); margin-bottom: 48px"
...
export default {
  ...
  created() {
    this.checked = Boolean(localStorage.getItem("remberchecked"))
  },
  // mounted() {
    ...
    markNameWord(e){
      ...
      if ( e == true){
        if(!window.localStorage){
            ...
            localStorage.setItem("remberchecked", e)
        }
      }
    },
...
<<<<<<< HEAD
      ...
      // tempData = [
      //   {"name":"首页","path":"/index"},
      //   {"name":"产品管理","path":"/productmanage/", "children": [{"name":"产品信息管理","path":"/productmanage/productinfomanage"}]},
      //   {"name":"产品参数管理","path":"/paramsmanage/","children":[{"name":"贷款市场利率管理(LPR)","path":"/productparamsmanage/ratemanage"},{"name":"产品期数管理","path":"/productparamsmanage/cpqsgl"},{"name":"还款间隔管理","path":"/productparamsmanage/hkjggl"},{"name":"费用参数管理","path":"/productparamsmanage/fycsgl"},{"name":"指标参数管理","path":"/productparamsmanage/zbcxgl"},{"name":"贴息机构管理","path":"/productparamsmanage/txjggl"}]},
      // ]
        ...
        if (valid && this.msg_onSuccess) {
          ...
          api.Login(loginList).then( res => {
            console.log("res", res)
              ...
              this.nickname = res.datas.sysUser.nickname
              ...
              api.getSideNav().then(res=> {
                ...
                // tempData = [
                //   {"loginName":"首页","path":"/index"},
                //   {"loginName":"产品参数管理","path":"/paramsmanage/","children":[{"loginName":"产品期数管理","path":"/productparamsmanage/cpqsgl"},{"loginName":"还款间隔管理","path":"/productparamsmanage/hkjggl"},{"loginName":"费用参数管理","path":"/productparamsmanage/fycsgl"},{"loginName":"指标参数管理","path":"/productparamsmanage/zbcxgl"},{"loginName":"贴息机构管理","path":"/productparamsmanage/txjggl"}]},
                // ]
                tempData = res.data
...
=======
      ...
      tempData = [
        ...
        {"name":"产品参数管理","path":"/paramsmanage/","children":[{"name":"产品期数管理","path":"/productparamsmanage/cpqsgl"},{"name":"还款间隔管理","path":"/productparamsmanage/hkjggl"},{"name":"费用参数管理","path":"/productparamsmanage/fycsgl"},{"name":"指标参数管理","path":"/productparamsmanage/zbcxgl"},{"name":"贴息机构管理","path":"/productparamsmanage/txjggl"}]},
      ]
      let this_route = tempData[0].path;
      if(tempData[0].children){
        this_route = tempData[0].children[0].path;
      ...
      //   }
      // })
>>>>>>> 677cb84f25dd1cd24bc476275036b9fcea115af7
    },
