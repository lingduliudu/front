      ...
      <div class="common-page-dataList">
        <el-tabs type="border-card" v-model="activeName" class="n-tabs">
          ...
          >
            <el-table
              ...
              style="width: 100%;"
            >
              <el-table-column prop="termCode" label="策略编码" min-width="150"></el-table-column>
              <el-table-column prop="period" label="策略" min-width="150"></el-table-column>
        ...
        >
          <div class="common-style">
            ...
            >
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="策略:" prop="period">
                    <el-input v-model.trim="ruleForm.period" placeholder="请输入策略"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row :gutter="20">
        ...
        >   
          <div class="common-style">
            <el-row :gutter="20">
              <el-col :span="12">
                <span class="info-key">策略编码: </span>
                <span class="info-value index">{{ruleForm.termCode}}</span>
              </el-col>
              <el-col :span="12">
                <span class="info-key">策略: </span>
...
export default {
  ...
  data() {
    return {
      ...
      isHedden: false,
      loading: false,
      otherFunc: [{ text: "+ 新增冲抵策略", func: this.openDialog }],
      filterList: [
        {
          label: "启用状态:",
          type: "select",
      ...
      rules: {
          period: [
            { required: true, message: '请选择策略说明', trigger: 'blur'},
            { pattern: /^[1-9]\d{0,19}$/, message: "策略说明为20位以内有效数字" }
          ],
      },
    };
  },
  ...
  methods: {
    ...
    handleStatus(row, onoff) {
      ...
      this.$confirm(text)
        .then(_ => {
          api.upDateFactoryTermStatus(params).then(res => {
            console.log(res, '------------res')
            if (res.code == 200) {
